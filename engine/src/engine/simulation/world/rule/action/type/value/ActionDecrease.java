...
public class ActionDecrease extends ActionValue {
    ...
    public ActionDecrease(EntityDefinition primaryEntity, EntityDefinition secondaryEntity, String propertyName, Expression value) {
        super(ActionType.decrease, primaryEntity, secondaryEntity, propertyName, value);
    }
